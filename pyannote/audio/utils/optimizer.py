            ...
            for group in self.param_groups:
                for p in group["params"]:
                    ...
                    if len(state) == 0:
                        ...
                        for j, _ in enumerate(loss_array):
                            ...
                            if amsgrad:
                                ...
                                state["max_exp_avg_sq" + str(j)] = torch.zeros_like(
                                    p.data
                                )
                    ...
                    if state["step"] == 1:
                        ...
                        p.norms[loss_index] = (p.norms[loss_index] * beta3) + (
                    ...
                    exp_avg, exp_avg_sq = (
                        state["exp_avg" + str(loss_index)],
                        state["exp_avg_sq" + str(loss_index)],
                    )
                    if amsgrad:
